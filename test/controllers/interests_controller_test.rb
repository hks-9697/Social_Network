...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { interest_topic: @interest.interest_topic, userid: @interest.userid } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { interest_topic: @interest.interest_topic, userid: @interest.userid } }
