...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { status: @friendship.status, userid1: @friendship.userid1, userid2: @friendship.userid2 } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { status: @friendship.status, userid1: @friendship.userid1, userid2: @friendship.userid2 } }
